...
from app.views import (aboutView, authView, contactsView, faqView, homeView, newsView, privacyPolicyView, ordersView,
...
urlpatterns = [
    ...
    path('orders/', ordersView.orders, name='orders'),
    ...
    re_path(r'^products/(?P<product_id>\d+)$/edit', productView.ProductDetailView.as_view(), name='product-details-edit'),
    re_path(r'^products/(?P<product_id>\d+)$/delete', productView.ProductDetailView.as_view(), name='product-details-delete'),
