...
class UserEmployee(BasicModel):
    name = models.CharField(max_length=100, help_text='Name and surname', editable=True)
    phone = models.CharField(max_length=13, unique=True, help_text='Phone number', editable=True)
    email = models.EmailField(max_length=50, unique=True, help_text='Email address', editable=True)
...
class Employee(BasicModel):
    db_id = models.ForeignKey(UserEmployee, on_delete=models.CASCADE, null=True)
